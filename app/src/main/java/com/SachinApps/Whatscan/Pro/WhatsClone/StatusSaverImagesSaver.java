...
public class StatusSaverImagesSaver extends Fragment {
    ...
    public StatusSaverImagesSaver(ArrayList<Uri> fileArrayList) {
        this.fileArrayList =fileArrayList;
    }

    public StatusSaverImagesSaver() {

    }


    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View layoutInflater1 = layoutInflater.inflate(com.SachinApps.Whatscan.Pro.WhatsClone.R.layout.whatsappscanfragment_images, viewGroup, false);
        this.rv = (RecyclerView) layoutInflater1.findViewById(com.SachinApps.Whatscan.Pro.WhatsClone.R.id.pictures_recyclerView);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.Q){
            ...
            this.rv.setAdapter(new StatusSaverPictureRecycler(getListFiles(new File(WHATSAPP_STATUSES_LOCATION)), getActivity()));
        }
    ...
    private void getData() {
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.Q) {
            try {
                statusModelArrayList = new ArrayList<>(); // Initialize the ArrayList
                ...
                this.rv.setAdapter(new StatusSaverPictureRecycler(statusModelArrayList, getActivity()));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
